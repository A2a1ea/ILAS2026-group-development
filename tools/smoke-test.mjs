...
try {
  ...
  assert(js.includes("function fireFlowerPattern"), "script.js should include Mirage Needle's flower bullet pattern");
  assert(js.includes("function drawBossWarnings"), "script.js should draw boss attack warnings");
