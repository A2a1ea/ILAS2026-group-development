...
- The current run loop is endless: survive a phase, forge word-board upgrades from collected letters, then continue into the next harder phase until game over.
...
- The current MVP includes scrolling background, enemies, enemy bullets, HP, upgrades, endless online flow rankings through the dev server, and game over.
